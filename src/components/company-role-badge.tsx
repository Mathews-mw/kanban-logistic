...
const companyRoleBadgeVariants = cva(
...
function CompanyRoleBadge({
	className,
	variant,
	asChild = false,
	...props
}: React.ComponentProps<'span'> & VariantProps<typeof companyRoleBadgeVariants> & { asChild?: boolean }) {
	const Comp = asChild ? Slot : 'span';

	return <Comp data-slot="ticket-status" className={cn(companyRoleBadgeVariants({ variant }), className)} {...props} />;
}

export { CompanyRoleBadge, companyRoleBadgeVariants };
